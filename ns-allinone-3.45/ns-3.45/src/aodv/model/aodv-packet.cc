    ...
    namespace aodv
    {
        ...
        RrepHeader::RrepHeader(uint8_t prefixSize,
            ...
            : m_flags(0),
              ...
              m_dstSeqNo(dstSeqNo),
              m_origin(origin),
              m_congestionFlag(0), // cc-aodv: Initialize congestion flag
              m_eccInfo(0)         // OPHD: Initialize ECC info byte
        {
        ...
        {
            return 21; // Standard 19 bytes + 1 byte congestion flag + 1 byte ECC info (OPHD)
        }
        ...
        RrepHeader::Serialize(Buffer::Iterator i) const
        {
            ...
            i.WriteU8(m_congestionFlag); // CC-AODV / ATM: Write congestion flag
            i.WriteU8(m_eccInfo);        // OPHD: Write ECC info byte (CL + HopQuality)
        }
        ...
        RrepHeader::Deserialize(Buffer::Iterator start)
        {
            ...
            m_congestionFlag = i.ReadU8(); // CC-AODV / ATM: Read congestion flag
            m_eccInfo = i.ReadU8();        // OPHD: Read ECC info byte
